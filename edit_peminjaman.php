...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE peminjaman 
            SET id_anggota='$id_anggota',id_buku='$id_buku',tanggal_pinjam='$tanggal_pinjam',tanggal_kembali='$tanggal_kembali' 
            ...
            <div class="card-body">
                <form method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="tanggal_pinjam" value="<?php echo $row["tanggal_pinjam"] ?>">
                    </div>

                    <div class="form-group">
                        <label for="Tahun Terbit">Tanggal Pengembalian</label>
                        <input type="date" class="form-control" name="tanggal_kembali" value="<?php echo $row["tanggal_kembali"] ?>">
                    </div>
